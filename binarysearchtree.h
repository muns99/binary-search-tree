...
/* ########################################### */
    ...
    Position max_below(Position p) const;
    /* [06] returns position of the smallest element larger than the value in p */
    Position min_above(Position p) const;
    ...
    double mean() const;
    /* [11] return position for data argument */
    Position getPosition(Elem data,bool valid = false);
